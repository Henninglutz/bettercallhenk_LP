#!/bin/bash
# HENK Fabric Module Migration Script - Fixed Version
...
echo "  → Environment Variablen hinzugefügt"
...
# Git Commit mit separatem Message-File
cat > /tmp/commit_message.txt << 'COMMIT_EOF'
